...
<link rel="stylesheet" href="/HRMS/CSS/attendanceManagement.css">
...
<body>
	...
	<div id="menu">
		<div id="leftMenu">
			<div class="leftMenuItems menuItems" onclick="window.location='punchIn.do'">Punch
				In</div>
			<div class="leftMenuItems menuItems"
				onclick="window.location='attendanceCalendar.do'">Attendance
				Calendar</div>
		</div>
		<div id="rightMenu">
